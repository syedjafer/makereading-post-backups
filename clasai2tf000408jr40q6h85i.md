...
> The insert() method takes two parameters:<br>
> **index** - the index where the element needs to be inserted<br>
> **element** - this is the element to be inserted in the list<br>
...
Sorting is `Case Sensitive` in list. The sort() method sorts the list ascending by default.
